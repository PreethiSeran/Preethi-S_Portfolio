...
const Hero = () => {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-hero-gradient-from/10 via-background to-hero-gradient-to/10 pt-16"
    >
      <div className="section-container text-center">
        <div className="animate-fade-in-up">
          ...
          <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
            Final-year B.Tech student passionate about creating meaningful and user-centered
            digital experiences
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            <Button
              asChild
              size="lg"
              className="bg-gradient-to-r from-hero-gradient-from to-hero-gradient-to hover:opacity-90 transition-opacity"
            >
      ...
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-hero-gradient-to/10 rounded-full blur-3xl -z-10" />
    </section>
  );
};
